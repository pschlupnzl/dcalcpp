...
const std::vector<testCase_t> numberCases = {
    ...
    { 
      "1 - ( 3 + 4 ) ^ ( 5 + 6 )",
      "1 - ( 3 + 4 ) ^ ( 5 + 6 )",
      "-1,977,326,742" // (1 - Math.pow(7, 11)).toString(),
     },
    { "V ( 4 )", "2v ( 4 )", "2" }, // TS: V -> sqrt
    { "1 0 / 2 * 5", "10 / 2 * 5", "25" },
    { "1 0 * 5 / 2", "10 * 5 / 2", "25" },
    ...
    { "4 . 5 @", "4.5^2", "20.25" },
    { "1 _ 2 @", "1_2^2", "1_4" },
    { "1 _ 2 _ 3 @", "1_2_3^2", "2_7_9" },

    { "V ( 4", "2v(4)", "2" },
    { "V ( ~ 4", "2v(-4)", "nan" },
    { "V ( 4 _ 9 )", "2v(4_9)", "2_3" },
    { "V ( 0 . 0 6 2 5 )", "2v(0.0625)", "0.25" },
    { "V ( 1 0 0", "2v(100)", "10" },
};
...
//   {"( tan ( ( 5 3 3 . 4 3 * 2 2 . 6 8 ) ) )", "", "0.7867076410974511"},
  {"2 8 6 . 2 6 - 9 9 9 . 2 3 - 7 6 5 . 1 3 + 4 3 0 . 3 5", "", "-1,047.75"},
//   {
//     "1 4 3 . 7 2 + ( 1 3 4 . 6 7 ) + sin ( 9 1 3 . 9 1 )",
//     "",
//     "278.14960253919537",
//   },
  {"4 6 4 . 9 2 - 3 5 7 . 5 7 * 2 0 0 . 3 6 - 5 1 9 . 8 7", "", "-71,697.6752"},
  {"3 5 . 5 5 + 4 4 8 . 0 0 * 1 1 3 . 4 6 * 4 9 2 . 7 0", "", "25,044,015.966"},
  {
